		...
		<div class="row">
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
				<div class="page-header-heading">
					<span class="am-icon-home page-header-heading-icon"></span>增加快捷菜单
				</div>
			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title am-fl">快捷菜单</div>
					...
					<div class="widget-body am-fr">
						<form class="am-form tpl-form-border-form tpl-form-border-br"
							method="post" action="/examLibrary/admin.php/Menu/editmenu">
							<input type="hidden" class="tpl-form-input" id="user-name"
								name="id" value="<?php echo ($list['id']); ?>">
							<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">快捷菜单名称
									<span class="tpl-form-line-small-title">Title</span>
								</label>
								<div class="am-u-sm-9">
									<input type="text" class="tpl-form-input" id="name"
										value="<?php echo ($list['name']); ?>" name="name" placeholder="请输入快捷菜单">
									<small>请填写快捷菜单。</small>
								</div>
							</div>
							<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">快捷菜单地址
									<span class="tpl-form-line-small-title">Url</span>
								</label>
								<div class="am-u-sm-9">
									<input type="text" class="tpl-form-input" id="url"
										value="<?php echo ($list['url']); ?>" name="url" placeholder="请输入快捷菜单地址">
									<small>请填写快捷菜单地址，并注意在英文输入法状态下填写。如:U('Index/index')</small>
								</div>
							</div>
							<div class="am-form-group">
								<label for="user-intro" class="am-u-sm-3 am-form-label">隐藏菜单
									<span class="tpl-form-line-small-title">status</span>
								</label>
								<div class="am-u-sm-9">
									<div class="tpl-switch">

										<?php if($list['status'] == '1' ): ?><input
											type="checkbox" name="status"
											class="ios-switch bigswitch tpl-switch-btn" checked="checked"
											value="1"> <?php else: ?> <input type="checkbox"
											name="status" class="ios-switch bigswitch tpl-switch-btn"><?php endif; ?>
