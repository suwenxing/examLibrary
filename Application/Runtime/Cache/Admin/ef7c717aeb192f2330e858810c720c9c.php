			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title  am-cf">快捷菜单管理</div>
					</div>
							...
							<div class="am-form-group">
								<div class="am-btn-toolbar">
									...
									<div class="am-form-group am-form-file">
										<a href="<?php echo U("Menu/addmenu");?>">
											<button type="button" class="am-btn am-btn-danger am-btn-sm">
												<i class="am-icon-cloud-upload"></i> 添加快捷菜单
											</button>
										</a>
									</div>
									...
									<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="gradeX">
										...
										<td>
											<div class="tpl-table-black-operation">
												<a href="<?php echo U('Menu/showmenu',array('id' => $vo['id']));?>"> <i class="am-icon-pencil"></i>
													编辑
												</a> <a href="<?php echo U('Menu/delmenu',array('id' => $vo['id']));?>"  onclick="return confirm('确定删除')" 
