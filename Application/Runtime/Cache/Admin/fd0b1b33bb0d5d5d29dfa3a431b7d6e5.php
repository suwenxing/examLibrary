...
-->
		...
		<li class="sidebar-nav-link"><a href="<?php echo U('Score/scorelist');?>"> <i
				...
				<div class="widget am-cf">
					...
					<div class="widget-body  am-fr">
								...
								<div class="am-btn-toolbar">
										...
										<div class="am-form-group am-form-file">
											<button type="button" class="am-btn am-btn-danger am-btn-sm">
												<i class="am-icon-file-excel-o"></i> 导出到本地
											</button>
						...
						<div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
							<form method="post" action="/examLibrary/admin.php/Score/seachscore">
							<div
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="gradeX">
										...
										<td><?php echo ($vo["class"]); ?></td>
									 	<th><?php echo ($vo["score"]); ?></th>
										<td>
											<div class="tpl-table-black-operation">
												<a href="<?php echo U('Student/showstu',array('id' => $vo['id']));?>">
													<i class="am-icon-pencil"></i> 编辑
												</a> <a href="<?php echo U('Student/delstu',array('id' => $vo['id']));?>"
