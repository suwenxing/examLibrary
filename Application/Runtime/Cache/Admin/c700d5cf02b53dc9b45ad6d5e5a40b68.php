			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title  am-cf">题目类型定义</div>
					</div>
									...
									<div class="am-form-group am-form-file">
										<a href="<?php echo U("Question/addtype");?>">
											<button type="button" class="am-btn am-btn-danger am-btn-sm">
												<i class="am-icon-cloud-upload"></i> 添加试题类型
											</button>
										</a>
									</div>
							...
							<table width="100%"
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="gradeX">
										<td><?php echo (subtext($vo["title"],30)); ?></td>
										<td>
											<div class="tpl-table-black-operation">
												<a href="<?php echo U('Question/addqueslist',array('id' => $vo['id']));?>"> <i class="am-icon-plus"></i>
													添加题目</a>
												<a href="<?php echo U('Question/edittype',array('id' => $vo['id']));?>"> <i class="am-icon-pencil"></i>
													编辑
												</a> <a href="<?php echo U('Question/deltype',array('id' => $vo['id']));?>"  onclick="return confirm('确定删除')" 
