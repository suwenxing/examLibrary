				...
				<div class="widget am-cf">
					...
					<div class="widget-body am-fr">
						...
						<form class="am-form tpl-form-border-form tpl-form-border-br"
							method="post" action="/examLibrary/admin.php/Student/editstu">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" class="tpl-form-input" id="title"
										name="username" value="<?php echo ($list['username']); ?>"
										placeholder="请输入学生姓名">
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" class="tpl-form-input" id="title"
										name="usernumber" value="<?php echo ($list['usernumber']); ?>"
										placeholder="请输入学生学号">
								</div>
							</div>
							<div class="am-form-group">
							...
							<div class="am-form-group" id="xy">
								...
								<div class="am-u-sm-9">
									<select data-am-selected="{searchBox: 0}" name="college"
										...
										<?php if(is_array($college)): foreach($college as $key=>$vo): if($vo['cname'] == $list['college']): ?><option value="<?php echo ($vo['cname']); ?>" selected="true"><?php echo ($vo['cname']); ?></option>
										<?php else: ?>
										<option value="<?php echo ($vo['cname']); ?>"><?php echo ($vo['cname']); ?></option><?php endif; endforeach; endif; ?>
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<select data-am-selected="{searchBox: 0}" name="class"
										...
										<?php if(is_array($class)): foreach($class as $key=>$vo): if($vo['clname'] == $list['class']): ?><option value="<?php echo ($vo['clname']); ?>" selected="true"><?php echo ($vo['clname']); ?></option>
										<?php else: ?>
										<option value="<?php echo ($vo['clname']); ?>"><?php echo ($vo['clname']); ?></option><?php endif; endforeach; endif; ?>
									</select>
								</div>
							</div>
							<div class="am-form-group">
	...
	$(function() {
		...
		$('#college').on(
				...
				function() {
					...
					var aj = $.ajax({
						url : "<?php echo U('Student/getClass');?>",// 跳转到 action  
						data : {
							cname : co,
						},
						type : 'post',
