							...
							<div class="am-form-group">
								<div class="am-btn-toolbar">
									...
									<div class="am-form-group am-form-file">
										<a href="/examLibrary/admin.php/Question/addtype?id=<?php echo ($id); ?>">
							...
							<table width="100%"
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="gradeX">
										...
										<td>
											<form action="/examLibrary/admin.php/Question/upload" method="post"
										...
										<td>
											<div class="tpl-table-black-operation">
												<a href="<?php echo U('Question/lookques',array('id' => $vo['id']));?>">
													<i class="am-icon-eye"></i> 查看</a>
												<a href="<?php echo U('Question/edittype',array('id' => $vo['id']));?>">
													<i class="am-icon-pencil"></i> 编辑
												</a> <a href="<?php echo U('Question/delquest',array('id' => $vo['id']));?>"
...
<script type="text/javascript">
		$(function() {
			$('#import').on('change', function() {
				$.AMUI.progress.start();
				var options = {
					url : '<?php echo U("Question/upload");?>',
					type : 'post',
