		...
		<div class="row">
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
				<div class="page-header-heading">
					<span class="am-icon-home page-header-heading-icon"></span>修改题目类型
				</div>
			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title am-fl">修改题目类型</div>
					...
					<div class="widget-body am-fr">
						...
						<form class="am-form tpl-form-border-form tpl-form-border-br"
							method="post" action="/examLibrary/admin.php/Question/editcate">
							<input type="hidden" name="id" value="<?php echo ($list['id']); ?>"> <input
								type="hidden" name="tid" value="<?php echo ($list['tid']); ?>">
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" class="tpl-form-input" id="title"
										name="title" value="<?php echo ($list['title']); ?>" placeholder="请输入题目文字">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<div class="tpl-switch">
										...
										<?php if($list['status'] == '1' ): ?><input type="checkbox" name="status"
											class="ios-switch bigswitch tpl-switch-btn" checked="checked" value="1">
											 <?php else: ?> 
											 <input type="checkbox" name="status"
											class="ios-switch bigswitch tpl-switch-btn" ><?php endif; ?>
