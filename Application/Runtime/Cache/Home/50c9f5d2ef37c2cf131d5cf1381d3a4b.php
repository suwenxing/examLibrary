	...
	<div class="am-container tpl-confirm-content">
		...
		<div class="container">
			...
			<div class="information">
				1.为了顺利完成测评，请在没有外界干扰的环境下进行测试，并关闭无关程序（尤其是下载工具），以确保网络连接畅通。<br>
				2.请认真阅读每一部分的指导语，并按指导语的要求作答；正式作答前，系统会提供练习题，练习题不计分、不计时。<br>
				3.作答过程中，系统自动计时，上一部分测验剩余的时间不会累加到下一部分，请把握好答题速度。<br>
				4.如遇网速较慢或文字、图片不能显示时，请关闭作答窗口，稍后更换网络环境后重新登录，继续作答。<br>
